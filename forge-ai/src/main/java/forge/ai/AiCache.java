...
public class AiCache {
    ...
    public static <T> T getCached(String key, Supplier<T> func, List<BiFunction<Object, Object, Boolean>> argsCheck, Object... args) {
        ...
        // dataMap is shared across all concurrent games in one JVM (Endstep). Guava's
        // synchronizedMultimap requires manual synchronization when iterating a returned
        // collection view, else a concurrent put/clear from another game throws CME.
